...
#define 		CALIBSOURCES_CONFIGURELOWFREQUENCYSOURCE_CMD_NUMBER 42
#define 		CALIBSOURCES_CONFIGURELOWFREQUENCYSOURCE_ID 3
#define 		CALIBSOURCES_CONFIGUREHIGHFREQUENCYSOURCE_CMD_NUMBER 41
#define 		CALIBSOURCES_CONFIGUREHIGHFREQUENCYSOURCE_ID 2
#define 		GPS_CUSTOMGPSCOMMAND_CMD_NUMBER 40
#define 		GPS_CUSTOMGPSCOMMAND_ID 1
#define 		PLATFORMMOTORS_CONFIGUREMOTORS_CMD_NUMBER 39
#define 		PLATFORMMOTORS_CONFIGUREMOTORS_ID 2
#define 		PLATFORMMOTORS_CONFIGUREELMOTOR_CMD_NUMBER 38
#define 		PLATFORMMOTORS_CONFIGUREELMOTOR_ID 1
#define 		PLATFORMMOTORS_CONFIGUREAZMOTOR_CMD_NUMBER 37
#define 		PLATFORMMOTORS_CONFIGUREAZMOTOR_ID 0
#define 		PLATFORMCONTROLER_CUSTOMCONTROLERMC405COMMAND_CMD_NUMBER 36
#define 		PLATFORMCONTROLER_CUSTOMCONTROLERMC405COMMAND_ID 1
#define 		HWP_HWPCOMMAND_CMD_NUMBER 35
#define 		HWP_HWPCOMMAND_ID 1
#define 		MGC3_TOMGC3_CMD_NUMBER 34
#define 		MGC3_TOMGC3_ID 0
#define 		MMR3_TOMMR3_CMD_NUMBER 33
#define 		MMR3_TOMMR3_ID 0
#define 		CFIBERS_CONFIGURECFIBERS_CMD_NUMBER 32
#define 		CFIBERS_CONFIGURECFIBERS_ID 1
#define 		RFSWITCHES_TORFSWITCHES_CMD_NUMBER 31
#define 		RFSWITCHES_TORFSWITCHES_ID 0
#define 		MULTINETQUICMANAGER_SETTESDAC_SINUS_CMD_NUMBER 30
#define 		MULTINETQUICMANAGER_SETTESDAC_SINUS_ID 25
#define 		MULTINETQUICMANAGER_SETTESDAC_TRIANGLE_CMD_NUMBER 29
#define 		MULTINETQUICMANAGER_SETTESDAC_TRIANGLE_ID 24
#define 		MULTINETQUICMANAGER_SETTESDAC_CONTINUE_CMD_NUMBER 28
#define 		MULTINETQUICMANAGER_SETTESDAC_CONTINUE_ID 23
#define 		MULTINETQUICMANAGER_SETHEATERRELAY_CMD_NUMBER 27
#define 		MULTINETQUICMANAGER_SETHEATERRELAY_ID 62
#define 		MULTINETQUICMANAGER_SETFEEDBACKRELAY_CMD_NUMBER 26
#define 		MULTINETQUICMANAGER_SETFEEDBACKRELAY_ID 61
#define 		MULTINETQUICMANAGER_ACTIVATEPID_CMD_NUMBER 25
#define 		MULTINETQUICMANAGER_ACTIVATEPID_ID 22
#define 		MULTINETQUICMANAGER_CONFIGUREPID_CMD_NUMBER 24
...
#define 		DISP_TXTTOEXTERNHK_CMD_NUMBER 0
#define 		DISP_TXTTOEXTERNHK_ID 9
#define 		DISP_DATATOEXTERNHK_CMD_NUMBER 0
#define 		DISP_DATATOEXTERNHK_ID 8
...
/** \@brief Encodes the DataToExternHk command and sends it.
 * 
 * Builds the DataToExternHk command with the given parameters.Sends it.
 * \@param [in] remoteIP TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] remotePort TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] commandId TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] data TBWTBWTBWTBWTBWTBWTBW
 */
bool sendDataToExternHk(QString remoteIP , quint16 remotePort , quint8 commandId , QByteArray data);

/** \@brief Encodes the TxtToExternHk command and sends it.
 * 
 * Builds the TxtToExternHk command with the given parameters.Sends it.
 * \@param [in] remoteIP TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] remotePort TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] commandId TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] data TBWTBWTBWTBWTBWTBWTBW
 */
bool sendTxtToExternHk(QString remoteIP , quint16 remotePort , quint8 commandId , QString data);
...
/** \@brief Encodes the SetTESDAC_Continue command and sends it.
 * 
 * Builds the SetTESDAC_Continue command with the given parameters.Sends it.
 * \@param [in] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] offsetADU TBWTBWTBWTBWTBWTBWTBW
 */
bool sendSetTESDAC_Continue(quint32 asicNum , quint16 offsetADU);

/** \@brief Encodes the SetTESDAC_Triangle command and sends it.
 * 
 * Builds the SetTESDAC_Triangle command with the given parameters.Sends it.
 * \@param [in] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] offsetADU TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] increment TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] period TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] undersampling TBWTBWTBWTBWTBWTBWTBW
 */
bool sendSetTESDAC_Triangle(quint32 asicNum , quint16 offsetADU , quint16 increment , quint16 period , quint16 undersampling);

/** \@brief Encodes the SetTESDAC_Sinus command and sends it.
 * 
 * Builds the SetTESDAC_Sinus command with the given parameters.Sends it.
 * \@param [in] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [in] offsetADU TBWTBWTBWTBWTBWTBWTBW
 ...
 * \@param [in] increment TBWTBWTBWTBWTBWTBWTBW
 */
bool sendSetTESDAC_Sinus(quint32 asicNum , quint16 offsetADU , quint16 amplitude , quint16 undersampling , quint8 increment);

/** \@brief Encodes the ToRfSwitches command and sends it.
 * 
 * Builds the ToRfSwitches command with the given parameters.Sends it.
 * \@param [in] txtMsg TBWTBWTBWTBWTBWTBWTBW
 */
bool sendToRfSwitches(QString txtMsg);
