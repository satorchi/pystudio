...
/** \@brief Decode the SetTESDAC_Continue command's fields.
 * 
 * Extract all custom fields of the SetTESDAC_Continue command.
 * \@param [in] pbTC Command buffer.
 * \@param [out] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] offsetADU TBWTBWTBWTBWTBWTBWTBW
 */
void decodeSetTESDAC_Continue(quint8* pbTC , /*@out@*/quint32 *asicNum , /*@out@*/quint16 *offsetADU);

/** \@brief Decode the SetTESDAC_Triangle command's fields.
 * 
 * Extract all custom fields of the SetTESDAC_Triangle command.
 * \@param [in] pbTC Command buffer.
 * \@param [out] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] offsetADU TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] increment TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] period TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] undersampling TBWTBWTBWTBWTBWTBWTBW
 */
void decodeSetTESDAC_Triangle(quint8* pbTC , /*@out@*/quint32 *asicNum , /*@out@*/quint16 *offsetADU , /*@out@*/quint16 *increment , /*@out@*/quint16 *period , /*@out@*/quint16 *undersampling);

/** \@brief Decode the SetTESDAC_Sinus command's fields.
 * 
 * Extract all custom fields of the SetTESDAC_Sinus command.
 * \@param [in] pbTC Command buffer.
 * \@param [out] asicNum TBWTBWTBWTBWTBWTBWTBW
 * \@param [out] offsetADU TBWTBWTBWTBWTBWTBWTBW
 ...
 * \@param [out] increment TBWTBWTBWTBWTBWTBWTBW
 */
void decodeSetTESDAC_Sinus(quint8* pbTC , /*@out@*/quint32 *asicNum , /*@out@*/quint16 *offsetADU , /*@out@*/quint16 *amplitude , /*@out@*/quint16 *undersampling , /*@out@*/quint8 *increment);
